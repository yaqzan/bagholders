...
# Strategy constants
# ---------------------------------------------------------------------------
# 15 DTE C1 SHIPPED 2026-04-28 (Phase 15B). Mirrors monte_carlo_15dte.py defaults.
INITIAL_CAPITAL     = 50_000.0
MAX_POSITIONS       = 8            # 15 DTE C1 (was 14 for 30 DTE — DD safety)
HOLD_CALENDAR_DAYS  = 7            # 15 DTE option, hard sell at half-DTE = bar 7
...
# 15 DTE: PREMIUM_MULT=1.29, DELTA=0.5  -> pct * 2.58 = sigma
TP_SIGMA_BASE       = 0.903        # +35% premium = 0.35 * 1.29 / 0.5
TP_SIGMA_STRESS     = 1.032        # +40% premium = 0.40 * 1.29 / 0.5
SL_SIGMA_BASE       = 0.774        # -30% premium = 0.30 * 1.29 / 0.5
SL_SIGMA_STRESS     = 0.903        # -35% premium = 0.35 * 1.29 / 0.5
...
F3F_CALL_FLOOR        = 0.40   # 15 DTE C1: was 0.50 (30 DTE); stronger weakness contraction
F3F_CALL_LOW          = 20.0   # breadth at which call floor is reached
F3F_PUT_THRESH        = 75.0   # breadth <= this -> no put cut
F3F_PUT_FLOOR         = 0.40   # 15 DTE C1: was 0.50; stronger weakness contraction
...
NET_TP_BASE     = +0.340   # +35% gross − 1.0% entry
NET_TP_STRESS   = +0.390   # +40% gross − 1.0% entry
NET_SL_BASE     = -0.323   # −30% gross − 1.0% entry − 1.3% SL exit
NET_SL_STRESS   = -0.373   # −35% gross − 1.0% entry − 1.3% SL exit
NET_HARD        = -0.465   # 15 DTE C1: −45% gross (was −40 for 30 DTE) − 1.0% entry − 0.5% hard exit
...
PUT_TP_SIGMA      = 0.903    # 15 DTE: 0.35 * 1.29 / 0.5 (was 1.274 for 30 DTE)
PUT_SL_SIGMA      = 0.516    # 15 DTE: 0.20 * 1.29 / 0.5 (was 0.728 for 30 DTE)
...
# DD circuit breaker (15 DTE C1, Phase 15B SHIPPED 2026-04-28).
# Pause new entries when running portfolio DD > this threshold; resume on recovery.
