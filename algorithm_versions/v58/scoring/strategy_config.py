...
class ScoringConfig:
    ...
    # ── Continuation echo wave (v51 ship; v58 retune 2026-05-13) ─────────
    CONT_BOOST_ENABLED: bool      # True
    CONT_BOOST_SIG_MIN: float     # minimum positive echo
    CONT_BOOST_TAU: float         # exp decay on gap days
    CONT_BOOST_MAG_EXP: float     # prior conviction exponent
    CONT_BOOST_SIG_NORM: float    # final tanh divisor
    ...
    CONT_BOOST_ALPHA: float       # echo lift scale
    CONT_BOOST_MAX_LIFT: float    # cap per signal
...
SCORING = ScoringConfig(
    ...
    CONT_BOOST_SIG_MIN=0.06314416804507036,
    CONT_BOOST_TAU=37.7342159721648,
    CONT_BOOST_MAG_EXP=0.6802379841567793,
    CONT_BOOST_SIG_NORM=1.0658971606985257,
    CONT_BOOST_GATE_LO=50,
    CONT_BOOST_GATE_HI=84,
    CONT_BOOST_PROMOTE_TARGET=75,
    CONT_BOOST_TARGET=85.0,
    CONT_BOOST_ALPHA=1.1681749185532881,
    CONT_BOOST_MAX_LIFT=5.264597294605774,
    CONT_BOOST_W7=0.28464019413712077,
    CONT_BOOST_W15=0.03293486929615211,
    CONT_BOOST_W30=0.9368411817737656,
    CONT_BOOST_W60=0.9492071805439206,
    CONT_BOOST_LOSS_PENALTY=0.17226097568036594,
    CONT_BOOST_FIZZLER_PENALTY=0.8054693453381145,
