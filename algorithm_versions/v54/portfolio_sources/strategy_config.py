...
class ScoringConfig:
    ...
    # ── POET — sector ETF participation echo/thrust wave (v54 ship) ──────
    # Score-stage dampener. Sector ETF crash echo pulls CALL signal-band
    # scores toward neutrality; sector ETF bull-repair thrust pulls PUT
    # signal-band scores toward neutrality. This persists changed Score.overall
    # rows and can withhold signals by moving them out of their qualifying bands.
    POET_WAVE_ENABLED: bool
    POET_CALL_MIN: int
    POET_PUT_MAX: int
    POET_CRASH_K: float
    POET_CALL_TARGET: float
    POET_CRASH_DECAY: float
    POET_REPAIR_K: float
    POET_SEED_LEVEL: float
    POET_SEED_VELOCITY: float
    POET_SEED_RSI: float
    POET_RELIEF_BRD_START: float
    POET_RELIEF_BRD_FULL: float
    POET_RELIEF_AVG5_START: float
    POET_RELIEF_AVG5_FULL: float
    POET_CRASH_POWER: float
    POET_BULL_RELEASE_K: float
    POET_PUT_K: float
    POET_PUT_TARGET: float
    POET_BULL_DECAY: float
    POET_BULL_VELOCITY: float
    POET_BULL_LEVEL: float
    POET_BULL_WASH_LEVEL: float
    POET_BULL_POWER: float
...
SCORING = ScoringConfig(
    ...
    # POET Participation Wave — sector ETF breadth dual-wave scoring
    # dampener. Shipped from corrected v53 DD-heavy Bayesian candidate
    # bayes_152. Crash echo dampens CALL signal scores; bull repair thrust
    # neutralizes PUT signal scores. Deterministic v53 replay evidence vs
    # baseline: full DD 98.90% -> 51.51% (-47.39pp), full return 3.01e22%
    # -> 3.50e24% (~116x), trades 6896 -> 6245, Covid +980.39, 2025 tariff
    # +167.79, preserve +58.48. Follow-ups: seed_004 improves DD/compound but
    # flips preserve negative; bayes_293 improves compound/other-shock while
    # giving up DD.
    POET_WAVE_ENABLED=True,
    POET_CALL_MIN=70,
    POET_PUT_MAX=25,
    POET_CRASH_K=0.6076307258820699,
    POET_CALL_TARGET=60.24227950236402,
    POET_CRASH_DECAY=0.8363462547374197,
    POET_REPAIR_K=0.34001684822355804,
    POET_SEED_LEVEL=13.738768982299018,
    POET_SEED_VELOCITY=29.23226543609054,
    POET_SEED_RSI=33.9230904893635,
    POET_RELIEF_BRD_START=35.06289226117375,
    POET_RELIEF_BRD_FULL=91.37244593241564,
    POET_RELIEF_AVG5_START=34.38625198767021,
    POET_RELIEF_AVG5_FULL=54.848369518759554,
    POET_CRASH_POWER=1.9996887703843815,
    POET_BULL_RELEASE_K=0.032504722010317295,
    POET_PUT_K=0.9856983213141354,
    POET_PUT_TARGET=30.678601504270443,
    POET_BULL_DECAY=0.9660230462016697,
    POET_BULL_VELOCITY=42.582415794006785,
    POET_BULL_LEVEL=81.6150704085743,
    POET_BULL_WASH_LEVEL=32.68693593017605,
    POET_BULL_POWER=1.6321451606694102,
    # PCD
    PCD_ENABLED=True,
    PCD_GATE=25,
