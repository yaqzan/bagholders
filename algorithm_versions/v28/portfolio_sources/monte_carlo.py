...
# Rationale: v27 PutTP=66.7% > CallTP=64.2% on 22-now (Phase 0); production order
# may be crowding out higher-WR puts.
PUT_PRIORITY = os.environ.get('PUT_PRIORITY', 'calls_first')   # 'calls_first' | 'puts_first' | 'merged'
