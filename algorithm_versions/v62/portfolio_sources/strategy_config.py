...
class ScoringConfig:
    ...
    MACD_PUT_GATE_MODE: str       # deep_salvage — preserve cliff except aligned deep PUTs
    MACD_PUT_WAVE_CENTER: float   # 26.0  — deep PUT setup center
    MACD_PUT_WAVE_WIDTH: float    # 1.0   — setup logistic width
    MACD_PUT_WAVE_SETUP_POWER: float  # 1.0
    MACD_PUT_WAVE_MACD_WIDTH: float   # 2.5 — bearish MACD logistic width
    MACD_PUT_WAVE_SUPPRESS: float     # 1.0
    MACD_PUT_WAVE_BOOST: float        # 0.65 — max restored MACD factor impulse
    MACD_PUT_WAVE_MIN_FACTOR: float   # 0.0
    MACD_PUT_WAVE_MAX_FACTOR: float   # 1.0
...
SCORING = ScoringConfig(
    ...
    # Asymmetric gates
    PUT_MACD_GATE=45.0,
    MACD_PUT_GATE_MODE='deep_salvage',
    MACD_PUT_WAVE_CENTER=26.0,
    MACD_PUT_WAVE_WIDTH=1.0,
    MACD_PUT_WAVE_SETUP_POWER=1.0,
    MACD_PUT_WAVE_MACD_WIDTH=2.5,
    MACD_PUT_WAVE_SUPPRESS=1.0,
    MACD_PUT_WAVE_BOOST=0.65,
    MACD_PUT_WAVE_MIN_FACTOR=0.0,
    MACD_PUT_WAVE_MAX_FACTOR=1.0,
