...
def _cmd_alloc(args):
    ...
    at runtime, so these auto-update when the dataclass is edited:
        ...
        15 DTE C1 (Phase 15B, prior — separate optimization path):
    ...
    EXITS:
        30 DTE (hard sell day 15) — v32_optim ship 2026-05-04:
            ...
            Puts   TP=+35% / SL=-20%
            Hard sell  -40%
        15 DTE C1 (hard sell day 7) — Phase 15B (prior values):
    ...
    strategy_label = "Phase 15B C1 (15 DTE)" if is_15dte else "v32_optim (30 DTE, ship 2026-05-04)"
