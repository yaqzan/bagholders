...
class Score(BaseModel):
    ...
    class Meta:
        ...
        indexes = (
            ...
            (('date',), False),          # For date range queries
            (('date', 'overall'), False), # For date + score filtering
            (('overall',), False),       # For score-based queries
            (('symbol', 'date', 'overall'), False), # Composite for complex queries
        )
