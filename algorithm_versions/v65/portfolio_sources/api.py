...
def live_allocation_endpoint():
    ...
    try:
        ...
        payload = build_live_allocation_plan(
            ...
            portfolio_profile=request.args.get('profile') or request.args.get('portfolio_profile') or 'sentinel',
        ...
        for path in paths:
            ...
            if portfolio_profile:
                if pack_profile and str(pack_profile) != str(portfolio_profile):
                    continue
                if not pack_profile and str(portfolio_profile) != 'sentinel':
                    continue
...
def _resolve_portfolio_profile_arg(default: str = 'sentinel') -> tuple[str, dict, dict]:
    import portfolio_profiles
