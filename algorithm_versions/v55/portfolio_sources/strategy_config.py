...
SCORING = ScoringConfig(
    ...
    # Sector breadth wave. v55 seed_099 replaced the earlier bayes_152
    # constants after v54 recalc/assessment showed the replay calibration did
    # not transfer cleanly. Replay vs v54 baseline: DD 79.20% -> 58.19%
    # (-21.01pp), return 1.31e23% -> 1.47e23%, Covid +37.90, 2025 tariff
    # +44.77, other shock +99.30; preserve/reference regressions are accepted
    # follow-up targets, not blockers for this ship.
    SECTOR_BREADTH_WAVE_ENABLED=True,
    SECTOR_BREADTH_WAVE_CALL_MIN=70,
    SECTOR_BREADTH_WAVE_PUT_MAX=25,
    SECTOR_BREADTH_WAVE_PARAMS={
        'crash_k': 0.7749893764666053,
        'call_target': 67.9111696519399,
        'crash_decay': 0.8293421380642926,
        'repair_k': 0.19416269886562104,
        'seed_level': 12.874193897976879,
        'seed_velocity': 26.351273803670814,
        'seed_rsi': 39.80229597898166,
        'relief_brd_start': 56.42302402263576,
        'relief_brd_full': 94.02551477406715,
        'relief_avg5_start': 54.4646105892826,
        'relief_avg5_full': 59.4646105892826,
        'crash_power': 1.1759310984435702,
        'bull_release_k': 0.8708083294000379,
        'put_k': 0.18819897434805938,
        'put_target': 43.99705733058449,
        'bull_decay': 0.8277690110627226,
        'bull_velocity': 60.646925383623845,
        'bull_level': 62.03404845065244,
        'bull_wash_level': 26.22552523349634,
        'bull_power': 2.088278407656689,
    },
    # PCD
    PCD_ENABLED=True,
    PCD_GATE=25,
