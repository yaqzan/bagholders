...
def main(command=None, args=None):
    ...
    if command == 'pull' and args:
        ...
        # Progressive pass windows (cumulative days, newest-first)
        _DEFAULT_PASS_DAYS = [7, 30, 365, 730, 1095]       # 7d, 30d, 1y, 2y, 3y
        _FULL_PASS_DAYS    = [1825, 3650, 9125]             # +5y, 10y, 25y
        _PASS_LABELS = {
            7: '7d', 30: '30d', 365: '1y', 730: '2y', 1095: '3y',
            1825: '5y', 3650: '10y', 9125: '25y',
        }
