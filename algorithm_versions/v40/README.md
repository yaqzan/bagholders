...
Source heading: `v40 (original ship summary, preserved for reference)` (from `.claude/docs/version-history-archive.md`)

### v40 - SVD: Score Velocity Dampener (ship 2026-05-06)

## Code Delta From Previous Resolved Version

Previous resolved key: `v39`
Diff range: `200f33a2..917659cb`
...
```text
ALGORITHM_VERSION         |  2 +-
database/models/core.py   | 81 +++++++++++++++++++++++++++++++++++++++++
database/utils/scoring.py | 93 +++++++++++++++++++++++++++++++++++++++++++++++
simulator.py              | 30 +++++++++++++--
