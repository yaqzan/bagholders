...
class AlgorithmVersion(BaseModel):
    ...
    DEFAULT_SELECTOR_VERSIONS = {
        64: (1, 'Boundary-freshness compare candidate'),
        44: (5, 'Best practical 2026 choice'),
        53: (8, 'Highest growth, more DD'),
        55: (10, 'Best drawdown protection'),
        57: (40, 'High-compound risk benchmark'),
        58: (41, 'Continuation echo retune'),
        59: (42, 'Daily volume authority wave'),
        60: (43, 'Current SCW/DD profile baseline'),
        61: (44, 'Weekly mature call guard'),
        62: (45, 'MACD put salvage wave'),
        65: (46, 'Weekly partial context comparison'),
        66: (47, 'Weekly momentum envelope on v60'),
    }
