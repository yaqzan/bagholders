    ...
    def calculate_overall_score(self, regime_multiplier=None):
        ...
        try:
            ...
            from database.utils.scoring import (
                ...
                build_weekly_ret4_map as _build_wk_ret4,
            )
            _wph_rows = list(
            ...
            if len(_wph_rows) >= 5:
                ...
                _wk_ret4_map = _build_wk_ret4(_wph_rows, _ph_recent)
                _wk_ret4 = _wk_ret4_map.get(self.date)
        except Exception:
            _kijun_pct = None
            _wv_force1 = None
            _wk_ret4 = None
...
class Stock(BaseModel):
    ...
    def calculate_scores_batched(self, silent=False, regime_multiplier=None, regime_composite=None):
        ...
        from database.utils.scoring import (
            ...
            build_weekly_ret4_map as _build_wk_ret4_map,
        )
        _wph_rows_asc = list(
        ...
        _wk_ret4_map = _build_wk_ret4_map(_wph_rows_asc, ph_rows_asc) if _wph_rows_asc else {}
            ...
            try:
                ...
                if 'overall' in components or changed:
                    ...
                    _score_kwargs = {
                        ...
                        'wk_ret4': _wk_ret4_map.get(score.date),
