...
class ScoringConfig:
    ...
    # Late CALL-side score-stage guard for mature weekly setups. It demotes
    # mid-band calls when weekly base/composite force, weekly volume force, and
    # 4-week weekly return look extended, while positive fresh weekly momentum
    # relieves the penalty.
    WEEKLY_MATURE_CALL_GUARD_ENABLED: bool
    WEEKLY_MATURE_CALL_GUARD_PARAMS: Mapping[str, float]
