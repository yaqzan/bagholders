...
from database.utils.scoring import (
    ...
    build_ret10d_sigma_map, build_signal_sigma_pct_map,
)
...
class Score(BaseModel):
    ...
    def calculate_overall_score(self, regime_multiplier=None):
        ...
        from database.utils.scoring import compute_ret_10d_sigma, compute_signal_sigma_pct
        _ph_recent = list(
        ...
        if len(_ph_recent) >= 61:
            ...
            _signal_sigma_pct = compute_signal_sigma_pct(_closes, len(_closes) - 1)
        ...
        score_kwargs = {
            ...
            'signal_sigma_pct': _signal_sigma_pct,
...
class Stock(BaseModel):
    ...
    def calculate_scores_batched(self, silent=False, regime_multiplier=None, regime_composite=None):
        ...
        _signal_sigma_pct_map = build_signal_sigma_pct_map(ph_rows_asc)
        ...
        for ind in ind_rows:
            ...
            try:
                ...
                overall, weight_info, vol_update = compute_overall_score(
                    ...
                    signal_sigma_pct=_signal_sigma_pct_map.get(d),
                    score_date=d,
                )
            ...
            try:
                ...
                if 'overall' in components or changed:
                    ...
                    _score_kwargs = {
                        ...
                        'signal_sigma_pct': _signal_sigma_pct_map.get(score.date),
