...
def _cmd_alloc(args):
    ...
    if DD_SOFT_BAND_HI > DD_SOFT_BAND_LO:
        print(f"    DD soft-band: {Fore.YELLOW}{int(DD_SOFT_BAND_LO*100)}%–{int(DD_SOFT_BAND_HI*100)}%{Style.RESET_ALL}   (scale call alloc 1.0×→{DD_SOFT_CALL_FLOOR:.2f}× linearly within band; calls only; H3 ship 2026-05-04)")
...
def _cmd_backtest(args):
    ...
    DD_CIRCUIT_BREAKER = _scfg_f3f.DD_CIRCUIT_BREAKER
