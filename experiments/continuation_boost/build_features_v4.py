...
PEAKS_PQ_V2     = OUT_DIR / 'peaks_v4.parquet'   # v4 outputs
PRIORS_PQ_V2    = OUT_DIR / 'priors_v4.parquet'

# Calls only (Q3: puts have no edge)
# v4: WIDEST UNIVERSE — admit calls 50-100 (sub-threshold 50-74 + already-qualifying 75+)
PEAK_CALL_LO   = 50
PEAK_CALL_HI   = 100
